  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center justify-center  py-4 px-4 w-24 rounded-xl text-xs font-medium transition-all duration-200  bg-gray-400 hover:bg-gray-50 text-white">
