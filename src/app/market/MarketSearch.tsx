...
const MarketSearch: React.FC<MarketSearchProps> = ({ isHeroMode = false, categoryNav, onCreateClick }) => {
  ...
  return (
    <div className="mt-3">
      ...
      {/* Category Nav */}
      {categoryNav && (
        <div className="mt-3 bg-neutral-100 border border-neutral-200 rounded-2xl px-3">
          {categoryNav}
        </div>
      )}
    </div>
