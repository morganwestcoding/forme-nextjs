...
const MarketSearch: React.FC<MarketSearchProps> = ({ isHeroMode = false }) => {
  ...
  const buttonBaseClasses = isHeroMode
    ...
    : "bg-white border border-gray-400 text-gray-600/90 hover:!bg-gray-100 hover:bg-none hover:border-gray-500 hover:text-gray-700 transition-all duration-500 ease-out";
      ...
      <div className="flex mt-4 gap-2">
        ...
        >
          <div className="relative w-[22px] h-[22px] flex items-center justify-center">
            ...
            >
              <span className="w-full h-full rounded-md border-[#60A5FA] border bg-blue-50 flex items-center justify-center text-sm font-semibold" style={{ color: '#60A5FA' }}>
