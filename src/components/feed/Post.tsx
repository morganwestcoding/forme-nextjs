        ...
        <>
         <div className='w-full h-auto rounded-lg shadow-sm bg-[#ffffff] p-6 md:mr-8 my-4 relative cursor-pointer' onClick={openModal}>
            ...
            <div className="mt-3 relative">
              ...
              <div className="flex items-center justify-center bg-slate-50 border border-[#71717A] rounded-full p-3 cursor-pointer   ">
...
<div 
  ...
  className="flex items-center justify-center bg-slate-50 border border-[#71717A] rounded-full p-3 cursor-pointer relative">  {/* Added 'relative' here */}
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 24 24" 
    width={19} 
  ...
  {likes.length > 0 && (
    <div className="absolute -top-1 -right-2 bg-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-thin text-neutral-500 shadow">
      {likes.length}
    </div>
  )}
</div>
                <div
                  ...
                  className="flex items-center bg-slate-50 border border-neutral-500 justify-center   rounded-full p-3 cursor-pointer relative">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 24 24" 
                    width={19} 
