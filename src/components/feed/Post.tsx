        ...
        <>
         <div className='w-full h-auto rounded-2xl drop-shadow-sm bg-[#ffffff] p-6 md:mr-8 my-4 relative cursor-pointer' onClick={openModal}>
            ...
            <div className="mt-3 relative">
              ...
              <div className="flex items-center justify-center bg-slate-50 rounded-full p-3 cursor-pointer shadow-sm border  border-[#6B7280] ">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={"#6B7280"} fill={"none"}>
    ...
    <path d="M8 13.5H16M8 8.5H12" stroke="#6B7280" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <div 
                  ...
                  className="flex items-center justify-center  rounded-full p-3 cursor-pointer border bg-slate-50  border-[#6B7280] shadow-sm">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 24 24" 
                    width={19} 
                ...
                <div
                  ...
                  className="flex items-center justify-center  rounded-full p-3 cursor-pointer bg-slate-50 shadow-sm border  border-[#6B7280] relative">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 24 24" 
                    width={19} 
