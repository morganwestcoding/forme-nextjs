         ...
         <div className='w-full h-auto rounded-2xl drop-shadow-sm bg-[#ffffff] p-6 md:mr-8 my-4 relative cursor-pointer' onClick={openModal}>
            ...
            <div className="mt-3 relative">
              ...
              <div className="bottom-0 left-0 flex space-x-3 p-2 -ml-2 -mb-4 mt-1.5">
                <div className="flex items-center justify-center  rounded-full p-3 cursor-pointer shadow-md bg-[#f7f6f6]">
                ...
                <div 
                  ...
                  className="flex items-center justify-center rounded-full p-3 cursor-pointer shadow-md relative bg-[#f7f6f6]">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 24 24" 
                    width={19} 
