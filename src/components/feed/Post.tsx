  ...
  return (
    ...
    <div className="absolute -top-1 -right-2 bg-white border rounded-full w-5 h-5 flex items-center justify-center text-xs text-[#a2a2a2] font-thin shadow-sm">
      {likes.length}
                            ...
                            {bookmarks.length > 0 && (
    <div className="absolute -top-1 -right-2 bg-white border border-gray-200 rounded-full w-5 h-5 flex items-center justify-center text-xs font-thing text-[#a2a2a2] shadow-sm">
      {bookmarks.length}
    </div>
  )}
                            </div>
