...
interface InputProps {
  ...
  /** NEW: optional class hooks */
  className?: string;        // applies to the outer wrapper
  inputClassName?: string;   // applies to input OR textarea element
}
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (type === "email") {
      ...
      if (!isValidEmail && e.target.value !== '') {
        // note: mutating errors isn't the RHF way, but keeping your behavior

        errors[id] = { type: 'manual', message: 'Please enter a valid email address' };
      }
    }
    onChange?.(e);
  };
