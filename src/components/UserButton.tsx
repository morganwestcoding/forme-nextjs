...
const UserButton: React.FC<UserButtonProps> = ({
  ...
  const buttonClass = noBg
    ...
    : "w-44 py-3 mt-1 px-4 bg-gray-50 border border-gray-300 flex items-center justify-start mb-6 cursor-pointer rounded-lg hover:from-blue-100/80 hover:via-blue-50 hover:to-blue-100 hover:border-[#60A5FA] [transition:background_400ms_ease-in-out,border-color_300ms_ease,box-shadow_300ms_ease] outline-none hover:shadow-md";
