...
const UserButton: React.FC<UserButtonProps> = ({
  ...
  const onRent = useCallback(() => {
    ...
    return (  
      ...
      <div className="inline-flex items-center justify-center whitespace-nowrap rounded-full drop-shadow-sm text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow-md bg-[#ffffff] bg-opacity-75 hover:bg-accent hover:text-accent-foreground">
