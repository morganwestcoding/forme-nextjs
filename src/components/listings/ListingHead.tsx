      ...
      <div className="w-full -mt-8 relative">
        <div className="pt-16 pb-8 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            {/* Enhanced Background */}
            <div 
              className="rounded-3xl p-6 border border-gray-100/50 backdrop-blur-sm shadow-sm"
              style={{
         ...
         <div className='text-white drop-shadow-sm'>
              ...
              {/* Bottom section - No grey container, redesigned counters */}
              <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-gray-100">
                ...
                <div className="flex gap-3 mb-4 sm:mb-0">
                  <span className="inline-flex items-center px-3 py-2.5 rounded-lg text-sm font-medium bg-gray-50 text-gray-700 border border-gray-200">
                  ...
                  <span className="inline-flex items-center px-3 py-2.5 rounded-lg text-sm  bg-gray-50 text-gray-700 border border-gray-200">
                ...
                {/* Action buttons with #60A5FA */}
                <div className="flex gap-3">
                  <button className="group px-4 py-2.5 rounded-lg text-sm  bg-white hover:bg-gray-50 text-gray-600 border border-gray-200 shadow-sm transition-all duration-200 flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="currentColor" fill="none" className="group-hover:scale-110 transition-transform">
                      <path d="M13.1977 8H10.8023C7.35836 8 5.03641 11.5806 6.39304 14.7994C6.58202 15.2477 7.0156 15.5385 7.49535 15.5385H8.33892C8.62326 15.5385 8.87111 15.7352 8.94007 16.0157L10.0261 20.4328C10.2525 21.3539 11.0663 22 12 22C12.9337 22 13.7475 21.3539 13.9739 20.4328L15.0599 16.0157C15.1289 15.7352 15.3767 15.5385 15.6611 15.5385H16.5047C16.9844 15.5385 17.418 15.2477 17.607 14.7994C18.9636 11.5806 16.6416 8 13.1977 8Z" stroke="currentColor" strokeWidth="1.5"></path>
                      <circle cx="12" cy="5" r="3" stroke="currentColor" strokeWidth="1.5"></circle>
                    </svg>
                    <span>Follow</span>
                  ...
                  <button className="group px-4 py-2.5 rounded-lg text-sm font-medium text-white shadow-sm hover:shadow-md transition-all duration-200 flex items-center space-x-2 border border-[#60A5FA]" style={{ backgroundColor: '#60A5FA' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="currentColor" fill="none" className="group-hover:scale-110 transition-transform">
