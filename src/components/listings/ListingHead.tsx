          ...
          <div className="w-full">
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="grid grid-cols-3 gap-2 py-2 w-full mb-4">
                ...
                <div className="bg-white px-2 shadow-sm py-2.5 rounded-xl flex flex-col items-center hover:shadow hover:border-gray-200 transition-all duration-300 group w-full">
                  <div className="flex items-center mb-1">
                    ...
                    <span className="font-medium text-gray-800 group-hover:text-gray-900 transition-colors duration-300">5.0</span>
                  </div>
                  <span className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-300">Rating</span>
                </div>
                
         
                <div className="bg-white px-2 py-2.5 rounded-xl shadow-sm flex flex-col items-center hover:shadow hover:border-gray-200 transition-all duration-300 group w-full">
                  <div className="flex items-center mb-1">
                    ...
                    <span className="font-medium text-gray-800 group-hover:text-gray-900 transition-colors duration-300">1M</span>
                  </div>
                  <span className="text-xs text-gray-500 group-hover:text-gray-600 transition-colors duration-300">Likes</span>
                </div>
                  ...
                  <div className="flex items-center mb-1">
                    <div className="bg-sky-50 p-1 rounded-md mr-1.5 group-hover:bg-sky-100 transition-colors duration-300">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="12" height="12" className="text-sky-500">
                        <path d="M18.7083 7C20.1334 8.59227 21 10.6949 21 13C21 17.9706 16.9706 22 12 22C7.02944 22 3 17.9706 3 13C3 10.6949 3.86656 8.59227 5.29168 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                        <path d="M12.0253 2.00052L12 14M12.0253 2.00052C11.8627 1.99379 11.6991 2.05191 11.5533 2.17492C10.6469 2.94006 9 4.92886 9 4.92886M12.0253 2.00052C12.1711 2.00657 12.3162 2.06476 12.4468 2.17508C13.3531 2.94037 15 4.92886 15 4.92886" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                      </svg>
                    </div>
                    <span className="font-medium text-gray-800 group-hover:text-gray-900 transition-colors duration-300">24k</span>
                  </div>
              ...
              */}
              ...
              {/* Gallery - Now positioned below the pills */}
