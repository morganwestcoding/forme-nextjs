...
const ListingHead: React.FC<ListingHeadProps> = ({ 
  ...
  // (kept logic) prefer listing.imageSrc first, then gallery fallback, then placeholder
  ...
  return (
    <div className="w-full">
            ...
            >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      {/* ✅ verified SVG next to the title (style from your reference) */}
              ...
              <div className="flex items-center justify-center pt-6 border-t border-gray-100">
                <div className="flex gap-4">
                  {isOwner ? (
                    /* ✅ Edit Listing button positioned like your reference (centered, above tabs) */
                    <button
      ...
      {/* Tabs — styled exactly like your reference (icons + active underline) */}
      <div className="mt-6">
          ...
          <div className="flex gap-8">
            {[
              ...
              >
                ...
                <span className={`transition-all duration-200 ${activeTab === key ? 'transform -translate-y-px' : ''}`}>{label}</span>
                {activeTab === key && (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {validServices.map(service => (
              <ServiceCard
                ...
                listingTitle={title}
                listingImage={service.imageSrc || galleryImages?.[0] || imageSrc}
                listing={listing}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {employees.map((employee: any, index: number) => (
              <WorkerCard
                ...
                employee={employee}
                listingTitle={title}
                data={{ title, imageSrc: mainImage, category: listing.category }}
                listing={listing}
                currentUser={currentUser}
                onFollow={() => {}}
                onBook={() => {}}
