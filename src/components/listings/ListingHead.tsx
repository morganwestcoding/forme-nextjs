...
const ListingHead: React.FC<ListingHeadProps> = ({ listing, currentUser }) => {
  ...
  return (
    ...
    <button className="px-4 py-3 bg-black border bg-opacity-60 border-white rounded-lg text-[#ffffff] text-sm hover:bg-opacity-20 transition">
