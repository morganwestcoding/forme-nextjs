  ...
  return (
    <div className="w-full">
      <div className="overflow-hidden relative">
        <div className="flex justify-between items-start bg-white shadow-sm rounded-xl pt-6 pb-5 px-6 mb-5">
          {/* Left Column */}
          <div className="flex flex-col items-start flex-1">
          <div className={`px-3 py-2 ${categoryColor} shadow-sm rounded-md flex items-center justify-center w-fit mb-2`} title={category}>
...
{/* Add the category label here */}
            ...
            <div className="flex items-start">
              <div className="flex items-center gap-2">
                {/* Heart Button */}
                <div className="flex items-center bg-slate-100 justify-center rounded-full p-3 cursor-pointer shadow-sm border ">
...
<div className="flex flex-col items-start w-96 gap-4">
  {/* Top Rating Section */}
  <div className="flex items-center gap-8 w-full pt-5 px-5 bg-slate-100 rounded-lg pb-4">
    {/* Average Rating */}
    <div className="flex flex-col items-center">
      ...
      <span className="text-xs text-gray-500">1,014,004 total</span>
    </div>
