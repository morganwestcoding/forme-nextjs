...
const ListingCard: React.FC<ListingCardProps> = ({
  ...
  return (
    ...
    <div 
      className={`px-3 py-2 backdrop-blur-sm bg-opacity-50 ${categoryColor} shadow-sm rounded-md border border-white flex items-center justify-center`} 
      title={data.category}
    >
      <span className="text-white text-xs font-extralight capitalize">
        {data.category}
           ...
           {/*   <div className="absolute top-3 right-3">
            ...
            <div className="flex justify-between items-start px-6 pt-3">
...
<div className="flex items-center gap-2">
  ...
  <div className="flex items-center gap-1">
    ...
    <span className="ml-1 text-sm mr-1 text-[#6B7280]">5.0</span>
  </div>
  ...
  <div className="flex items-center gap-1">
    ...
    <span className="ml-1 text-sm text-gray-500">12.3k</span>
  </div>
</div>
            </div>
              ...
              {data.services && data.services.length > 0 && (
                <div className="inline-flex items-center gap-2 px-3 py-3 bg-gray-100 shadow-sm rounded-lg hover:bg-neutral-200 transition">
                  <div className="flex gap-1.5">
                    <button
                      ...
                      className="text-white hover:text-neutral-600 transition cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="textwhite hover:text-neutral-600 transition cursor-pointer"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" color="#6B7280" fill="none">
