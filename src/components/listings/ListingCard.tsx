...
const ListingCard: React.FC<ListingCardProps> = ({
  ...
  <div className="absolute bottom-4 left-6">
    <div 
      className={`w-20 py-2 backdrop-blur-sm bg-opacity-70 ${categoryColor} shadow-sm rounded-md border border-white flex items-center justify-center`} 
      title={data.category}
    >
  ...
  {/* Stacked heart and star on right */}
  <div className="absolute top-4 right-6 flex flex-col gap-2
  ">
    {/* Heart with Count */}
    <div className="flex items-center justify-center gap-1 bg-black bg-opacity-50 backdrop-blur-sm p-3 rounded-full">
      <svg 
    ...
    {/* Star Rating */}
    <div className="flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-3 rounded-full">
      <svg 
        xmlns="http://www.w3.org/2000/svg" 
        viewBox="0 0 24 24" 
        width="21" 
...
<div className="flex justify-center items-center w-full px-6 pt-2 pb-2">
