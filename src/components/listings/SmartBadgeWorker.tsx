    ...
    <div className="bg-white/10 backdrop-blur-md rounded-xl p-1 border border-white/30 shadow-xl">
      ...
      <div className="flex items-center gap-3 mb-3 px-3 pt-3">
        ...
        <div className="relative w-16 h-16 flex-shrink-0">
          <Image
            ...
            width={64}
            height={64}
            className="w-full h-full border-2 border-white/50 rounded-full object-cover shadow-lg"
          />
        </div>
        
        {/* Name and title next to profile image */}
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-1">
            <h1 className="text-lg font-medium text-white drop-shadow-lg">{employee.fullName}</h1>
      ...
      <div className="flex items-center p-1">
        ...
        >
          ...
          <div className={`border rounded-lg px-3 py-1.5 mb-2 group-hover:scale-110 transition-all duration-300 ${ratingProps.bgColor} ${ratingProps.borderColor} ${ratingProps.glowColor} shadow-sm w-24 flex justify-center`}>
