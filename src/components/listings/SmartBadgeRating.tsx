...
const SmartBadgeRating: React.FC<SmartBadgeRatingProps> = ({
  ...
  const getStatusBorderColor = (color: string) => {
    switch (color) {
      case 'green': return 'border-white/35 hover:border-green-300/60';
      case 'orange': return 'border-white/35 hover:border-yellow-300/60';
      case 'red': return 'border-white/35 hover:border-rose-400/60';
      default: return 'border-white/35 hover:border-white/60';
    }
  };
