    ...
    <div className="flex items-center gap-2">
      ...
      >
        {showPrice ? (
          ...
          // Rating display with star icon (filled like SmartBadgeWorker)
          <>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="12" height="12" className={iconColorClasses}>
