      ...
      <div className="flex justify-start space-x-2 mb-6">
        ...
        >
          <div className="flex flex-col rounded p-1 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" color="#a2a2a2" fill="none">
        ...
        >
          <div className="flex flex-col rounded-full p-1 cursor-pointer">
            <svg 
              ...
              height="18" 
              color="#a2a2a2" 
              fill={hasFavorited ? '#b1dafe' : 'rgba(0, 0, 0, 0.5)'}
            >
              <path 
          ...
          <span className="ml-2 text-[#a2a2a2] text-xs group-hover:text-white font-light">
