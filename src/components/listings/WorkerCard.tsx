...
interface WorkerCardProps {
  ...
  listingTitle: string; // Title of the listing this worker is associated with
  data: {
    title: string;
    imageSrc: string;
  };// Add this prop for the listing image
  onFollow?: () => void;
  onBook?: () => void;
}
...
const WorkerCard: React.FC<WorkerCardProps> = ({
  ...
  return (
    <div className="cursor-pointer bg-white rounded-xl shadow-sm hover:shadow-2xl overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 right-0 h-[130px] overflow-hidden">
            <Image
...
<button 
  ...
  className="bg-neutral-100 text-neutral-600 py-3 px-4 rounded-xl hover:bg-gray-200 transition-all duration-200 flex items-center justify-center"
>
