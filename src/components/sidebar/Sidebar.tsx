...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="fixed top-0 flex h-screen z-50">
      <div className="flex flex-col items-center w-52 h-full px-10 pb-10 pt-8 bg-white backdrop-blur-full bg drop-shadow-sm rounded-tr-2xl" >
        ...
        <ul className="list-none m-0 p-0 flex flex-col items-center hover:text-white ">
          ...
          selectedButton === 'home' ? 'bg-[#5E6365] border-[#5E6365]' : 'bg-[#ffffff] hover:bg-[#DFE2E2]'
          } w-36`}
          onClick={() => {
            router.push('/');
    ...
    selectedButton === 'home' ? 'text-white' : 'text-[#a2a2a2] group-hover:text-white'
          ...
          <li className={`group flex items-center justify-start mb-3 p-2 rounded-lg border transition-colors duration-250 ${
              selectedButton === 'market' ? 'bg-[#5E6365] border-[#5E6365]' : 'bg-[#ffffff] hover:bg-[#DFE2E2] hover:border-[#DFE2E2]'
            } w-36`} 
            onClick={() => {
              router.push('/market');
          ...
          <div className="group flex flex-col  rounded-full p-1 cursor-pointer" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={18} height={18} color={selectedButton === 'market' ? "#ffffff" : "#a2a2a2"}  fill={selectedButton === 'market' ? "#5E6365" : "none"}  className=" group-hover:text-white">
            ...
            <span className={`ml-4 text-[0.8rem] font-light ${
                selectedButton === 'market' ? 'text-white' : 'text-[#a2a2a2] group-hover:text-white hover:border-[#DFE2E2]'
              }`}>Market</span>
            </li>
           ...
           <li className={`group flex items-center justify-start mb-3 p-2 rounded-lg border transition-colors duration-250 ${
              selectedButton === 'favorites' ? 'bg-[#5E6365] border-[#5E6365]': 'bg-[#ffffff] hover:bg-[#DFE2E2] hover:border-[#DFE2E2]'
            } w-36`} 
            onClick={() => {
         ...
         <li className={`group flex items-center justify-start mb-3 p-2 rounded-lg border transition-colors duration-250 ${
    selectedButton === 'jobs' ? 'bg-[#5E6365] border-[#5E6365]' : 'bg-[#ffffff] hover:bg-[#DFE2E2] hover:border-[#DFE2E2]'
  } w-36`} 
  onClick={() => {
    router.push('/jobs');
  ...
  <span className={`ml-4 text-[0.8rem] font-light ${
    ...
    selectedButton === 'bookings' ? 'bg-[#5E6365] border-[#5E6365]' : 'bg-[#ffffff] hover:bg-[#DFE2E2] hover:border-[#DFE2E2]'
  } w-36`} 
  onClick={() => {
