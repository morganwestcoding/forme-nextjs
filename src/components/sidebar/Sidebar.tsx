...
<Logo variant="vertical" />
  ...
  <span className={`ml-3 text-[0.8rem] font-light ${
    ...
    selectedButton === 'home' ? 'text-white' : 'text-[#71717A] group-hover:text-white'
          ...
          <div className="group flex flex-col  rounded-full p-1 cursor-pointer" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'market' ? "#ffffff" : "#71717A"}  fill={selectedButton === 'market' ? "#71717A" : "none"}  className=" group-hover:text-white">
            ...
            <path className={`${selectedButton !== 'market' ? 'group-hover:stroke-white' : 'none'}`} d="M15 16.9768C14.3159 17.584 13.2268 17.9768 12 17.9768C10.7732 17.9768 9.68409 17.584 9 16.9768" stroke={selectedButton === 'market' ? "#71717A" : "#71717A"} strokeWidth="1.5" strokeLinecap="round" />
