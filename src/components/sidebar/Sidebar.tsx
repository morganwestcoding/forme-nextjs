...
>
  ...
  <span className={`ml-3 text-sm font-light ${
    selectedButton === 'explore' ? 'text-white' : 'text-[#71717A] group-hover:text-white'
          ...
          selectedButton === 'home' ? 'bg-slate-500' : ' hover:bg-gray-200'
          } w-44`}
          onClick={() => {
            router.push('/');
          ...
          >
            <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={23} height={23} color={selectedButton === 'home' ? "#ffffff" : "#71717A"} fill={selectedButton === 'home' ? "#ffffff" : "none"} className="group-hover:text-white">
    ...
    selectedButton === 'home' ? 'text-white' : 'text-[#71717A] group-hover:text-white'
          ...
          <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'market' ? "#ffffff" : "#71717A"}  fill={selectedButton === 'market' ? "#64748B" : "none"}  className=" group-hover:text-white">
          ...
          <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors" onClick={() => router.push('/favorites')}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'favorites' ? "#ffffff" : "#71717A"} fill={selectedButton === 'favorites' ? "#ffffff" : "none"} className=" group-hover:text-white">
  ...
  <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'jobs' ? "#ffffff" : "#71717A"}  fill={"none"} className="group-hover:text-white">
...
onClick={() => {
  ...
  onClick={() => {
    ...
    inboxModal.onOpen(currentUser); 
  }}
>
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'inbox' ? "#ffffff" : "#71717A"} fill="none" className="group-hover:text-white">
      ...
      {/* <div className="bg-[#F9AE8B] p-1.5 rounded-full flex items-center justify-center">
    ...
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex flex-col rounded-full p-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'notifications' ? "#ffffff" : "#71717A"} fill="none" className="group-hover:text-white">
