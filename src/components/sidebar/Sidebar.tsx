...
<div className="w-44 h-[1px] rounded-full bg-gray-200 mb-4"></div>
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'home' ? "#ffffff" : "#a2a2a2"} fill={selectedButton === 'home' ? "#ffffff" : "none"} className="group-hover:text-white">
                ...
                <path className={`${selectedButton !== 'home' ? 'group-hover:stroke-white' : ''}`} d="M12 16H12.009" stroke={selectedButton === 'home' ? "#5E6365" : "#a2a2a2"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
    ...
    selectedButton === 'home' ? 'text-white' : 'text-[#a2a2a2] group-hover:text-white'
          ...
          <div className="group flex flex-col  rounded-full p-1 cursor-pointer" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'market' ? "#ffffff" : "#a2a2a2"}  fill={selectedButton === 'market' ? "#5E6365" : "none"}  className=" group-hover:text-white">
            ...
            <path className={`${selectedButton !== 'market' ? 'group-hover:stroke-white' : ''}`} d="M15 16.9768C14.3159 17.584 13.2268 17.9768 12 17.9768C10.7732 17.9768 9.68409 17.584 9 16.9768" stroke={selectedButton === 'market' ? "#5E6365" : "#a2a2a2"} strokeWidth="1.5" strokeLinecap="round" />
          ...
          <div className="group flex  flex-col rounded-full p-1 cursor-pointer" onClick={() => router.push('/favorites')}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'favorites' ? "#ffffff" : "#a2a2a2"} fill={selectedButton === 'favorites' ? "#ffffff" : "none"} className=" group-hover:text-white">
  ...
  <div className="group flex flex-col rounded-lg p-1 cursor-pointer">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'jobs' ? "#ffffff" : "#a2a2a2"}  fill={"none"} className="group-hover:text-white">
  ...
  <div className="group flex flex-col rounded-full p-1 cursor-pointer">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} className="group-hover:text-white">
  {/* Base calendar shape */}
  <path 
  ...
  <path 
    ...
    stroke={selectedButton === 'bookings' ? "#5E6365" : "#a2a2a2"} 
    strokeWidth="1.5" 
    strokeLinecap="round" 
    className={`${selectedButton !== 'bookings' ? 'group-hover:stroke-white' : ''}`}
  />
...
onClick={() => {
  ...
  setSelectedButton('inbox');
    ...
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex flex-col rounded-full p-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'inbox' ? "#ffffff" : "#a2a2a2"} fill="none" className="group-hover:text-white">
...
onClick={() => {
  ...
  setSelectedButton('notifications');
    ...
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex flex-col rounded-full p-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={19} height={19} color={selectedButton === 'notifications' ? "#ffffff" : "#a2a2a2"} fill="none" className="group-hover:text-white">
