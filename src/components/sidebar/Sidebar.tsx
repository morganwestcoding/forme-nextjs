  ...
  return (
    ...
    <div className="fixed top-0 flex h-screen z-50">
      <div className="flex flex-col items-center w-56 h-full p-10 bg-[#ffffff]  bg-opacity-85 rounded-r-2xl drop-shadow-sm" >
        <Logo/>
        <div className="pt-9 text-xs font-medium text-[#4d4d4d] mb-6">
          Menu
        </div>
        ...
        <ul className="list-none m-0 p-0 flex flex-col items-center">
          ...
          <li className="flex items-center justify-start mb-5 p-2  rounded-full shadow-sm hover:bg-[#48DBFB] bg-white  w-36">
          ...
          <CottageRoundedIcon className="w-4 h-4 hover:text-[#48DBFB] text-[#ffffff]"/>
                  ...
                  <span className="ml-6 text-[#4d4d4d] text-xs font-normal hover:text-white">Home</span>
          ...
          <li className="flex items-center justify-start mb-5 p-2  rounded-full shadow-sm bg-white w-36">
          <div className="flex flex-col bg-[#b7b7b7] rounded-full p-1 cursor-pointer drop-shadow-sm" onClick={() => router.push('/market')}>
            ...
            <span className="ml-5 text-[#4d4d4d] text-xs font-normal ">Market</span>
          ...
          <span className="ml-4 text-[#4d4d4d] text-xs font-normal ">Favorites </span>
         ...
         {/* Job Icon with Tooltip */}
          ...
          <span className="ml-6 text-[#4d4d4d] text-xs font-normal ">Jobs</span>
          ...
          <span className="ml-4 text-[#4d4d4d] text-xs font-normal ">Bookings</span>
