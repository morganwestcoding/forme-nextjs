...
isMobile }) => {
  ...
  return (
    ...
    <div className="fixed top-0 flex h-screen z-20">
      <div className="flex flex-col items-center w-62 h-full px-6 pb-10 pt-8 bg-black backdrop-blur-full  z-50" >
...
<div className="w-44 h-[1px] rounded-full bg-gray-200 mb-4 mt-1"></div>
          <li className={`group flex border border-white items-center justify-start mb-2 p-2  rounded-lg  transition-colors duration-250 ${
          selectedButton === 'home' ? 'bg-gray-500' : ' hover:bg-gray-200'
          } w-44`}
          onClick={() => {
            router.push('/');
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'home' ? "#ffffff" : "#ffffff"} fill={selectedButton === 'home' ? "#ffffff" : "none"} className="group-hover:text-white">
                ...
                <path className={`${selectedButton !== 'home' ? 'group-hover:stroke-white' : ''}`} d="M12 16H12.009" stroke={selectedButton === 'home' ? "#5E6365" : "#ffffff"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          
          </div>
          <span className={`ml-3 text-[0.8rem] font-light ${
    selectedButton === 'home' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
  }`}>Home</span>
          ...
          <li className={`group flex items-center border border-white justify-start mb-2 p-2 rounded-lg  transition-colors duration-250 ${
              selectedButton === 'market' ? 'bg-gray-500' : ' hover:bg-gray-200 hover:-gray-200'
            } w-44`} 
            onClick={() => {
              router.push('/market');
          ...
          <div className="group flex flex-col  rounded-full p-1 cursor-pointer" >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'market' ? "#ffffff" : "#ffffff"}  fill={selectedButton === 'market' ? "#5E6365" : "none"}  className=" group-hover:text-white">
            ...
            <path className={`${selectedButton !== 'market' ? 'group-hover:stroke-white' : ''}`} d="M15 16.9768C14.3159 17.584 13.2268 17.9768 12 17.9768C10.7732 17.9768 9.68409 17.584 9 16.9768" stroke={selectedButton === 'market' ? "#5E6365" : "#ffffff"} strokeWidth="1.5" strokeLinecap="round" />
            ...
            <span className={`ml-3 text-[0.8rem] font-light ${
                selectedButton === 'market' ? 'text-white' : 'text-[#ffffff] group-hover:text-white hover:-gray-200'
              }`}>Market</span>
            </li>
           ...
           <li className={`group flex items-center border border-white justify-start mb-2 p-2 rounded-lg  transition-colors duration-250 ${
              selectedButton === 'favorites' ? 'bg-gray-500': ' hover:bg-gray-200 hover:-gray-200'
            } w-44`} 
            onClick={() => {
          ...
          <div className="group flex  flex-col rounded-full p-1 cursor-pointer" onClick={() => router.push('/favorites')}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'favorites' ? "#ffffff" : "#ffffff"} fill={selectedButton === 'favorites' ? "#ffffff" : "none"} className=" group-hover:text-white">
          ...
          <span className={`ml-3 text-[0.8rem] font-light ${
                selectedButton === 'favorites' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
              }`}>Favorites</span>
         ...
         <li className={`group flex items-center border border-white justify-start mb-2 p-2 rounded-lg  transition-colors duration-250 ${
    selectedButton === 'jobs' ? 'bg-gray-500' : 'hover:bg-gray-200 hover:-gray-200'
  } w-44`} 
  onClick={() => {
    router.push('/jobs');
  ...
  <div className="group flex flex-col rounded-lg p-1 cursor-pointer">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'jobs' ? "#ffffff" : "#ffffff"}  fill={"none"} className="group-hover:text-white">
  ...
  <span className={`ml-3 text-[0.8rem] font-light ${
    selectedButton === 'jobs' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
  }`}>Jobs</span>
</li>

          <li className={`group flex border border-white items-center justify-start mb-2 p-2 rounded-lg  transition-colors duration-250 ${
    selectedButton === 'bookings' ? 'bg-gray-500' : ' hover:bg-gray-200 hover:-gray-200'
  } w-44`} 
  onClick={() => {
  ...
  <div className="group flex flex-col rounded-full p-1 cursor-pointer">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} className="group-hover:text-white">
  {/* Base calendar shape */}
  <path 
    d="M2.5 12.2432C2.5 7.88594 2.5 5.70728 3.75212 4.35364C5.00424 3 7.01949 3 11.05 3H12.95C16.9805 3 18.9958 3 20.2479 4.35364C21.5 5.70728 21.5 7.88594 21.5 12.2432V12.7568C21.5 17.1141 21.5 19.2927 20.2479 20.6464C18.9958 22 16.9805 22 12.95 22H11.05C7.01949 22 5.00424 22 3.75212 20.6464C2.5 19.2927 2.5 17.1141 2.5 12.7568V12.2432Z" 
    stroke={selectedButton === 'bookings' ? "#000000" : "#ffffff"} 
  ...
  <path 
    ...
    stroke={selectedButton === 'bookings' ? "#5E6365" : "#ffffff"} 
    strokeWidth="1.5" 
    strokeLinecap="round" 
    className={`${selectedButton !== 'bookings' ? 'group-hover:stroke-white' : ''}`}
  />
  ...
  <span className={`ml-3 text-[0.8rem] font-light ${
    selectedButton === 'bookings' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
  }`}>Bookings</span></div>
...
<li className={`group flex items-center justify-start border border-white mb-4 p-2 rounded-lg transition-colors duration-250 ${
  selectedButton === 'vendors' ? 'bg-gray-500' : ' hover:bg-gray-200 hover:-gray-200'
} w-44`} 
onClick={() => {
  router.push('/vendors');
  ...
  <div className="group flex flex-col rounded-full p-1 cursor-pointer">
    <svg 
      ...
      width={20} 
      height={20} 
      color={selectedButton === 'vendors' ? "#ffffff" : "#ffffff"}
      fill="none"
  ...
  <span className={`ml-3 text-[0.8rem] font-light ${
    selectedButton === 'vendors' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
  }`}>Vendors</span>
</li>
...
onClick={() => {
  ...
  setSelectedButton('inbox');
    ...
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex flex-col rounded-full p-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'inbox' ? "#ffffff" : "#ffffff"} fill="none" className="group-hover:text-white">
            ...
            <span className={`ml-3 text-[0.8rem] font-light ${
                selectedButton === 'inbox' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
            }`}>Inbox</span>
        </div>
        <div className="bg-[#78C3FB] px-2 py-1 rounded-sm flex items-center justify-center">
...
<li className={`group flex items-center justify-start border border-white mb-2 p-2 rounded-lg transition-colors duration-250 ${
...
onClick={() => {
  ...
  setSelectedButton('notifications');
    ...
    <div className="flex items-center justify-between w-full">
        <div className="flex items-center">
            <div className="group flex flex-col rounded-full p-1 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={20} height={20} color={selectedButton === 'notifications' ? "#ffffff" : "#ffffff"} fill="none" className="group-hover:text-white">
            ...
            <span className={`ml-3 text-[0.8rem] font-light ${
                selectedButton === 'notifications' ? 'text-white' : 'text-[#ffffff] group-hover:text-white'
            }`}>Notifications</span>
        </div>
        <div className="bg-[#78C3FB] px-2 py-1 rounded-sm flex items-center justify-center">
