...
>
  ...
  <span className={`ml-3 text-sm font-light ${
    selectedButton === 'explore' ? 'text-white' : 'text-[#71717A] group-hover:text-white'
          ...
          >
            <div className="group flex items-center justify-center w-8 h-8 rounded-full p-1 cursor-pointer transition-colors" >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={21} height={21} color={selectedButton === 'home' ? "#ffffff" : "#71717A"} fill={selectedButton === 'home' ? "#ffffff" : "none"} className="group-hover:text-white">
