...
function CloseFriends() {
  return (
    <div className='pt-4'>
      <div className='pb-5 font-medium text-xs flex flex-col items-center justify-center text-[#4d4d4d] underline underline-offset-8'>Recents
  
      </div>
      
      <div className='w-full rounded-2xl flex items-center justify-center h-38 bg-white drop-shadow-sm'>
        <ul className='w-full h-full grid grid-cols-2 gap-4 p-4 justify-items-center '>
          {/* Circle 1 */}
