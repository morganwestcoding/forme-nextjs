  ...
  return (
    <div
      ...
      className="p-3 rounded-full bg-white/80 backdrop-blur-sm 
                hover:bg-white hover:scale-110 transition-all duration-300 shadow-lg cursor-pointer"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      ...
      >
        <path
          ...
          fill={hasFavorited ? '#E45358' : 'rgba(0, 0, 0, 0.05)'}
        />
      </svg>
    </div>
  );
