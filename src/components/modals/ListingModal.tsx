    ...
    bodyContent = (
      <div className="flex flex-col gap-5">
        {isProfileImage ? (
          <>
            <div className="text-center">
              <h3 className="text-lg font-semibold text-gray-900">Edit main listing photo</h3>
              ...
              <div className="flex-1 min-w-0 space-y-4">
                <div>
                  ...
                  <ImageUpload
                    ...
                    onRemove={() => setCustomValue('imageSrc', '')}
                    ratio="square"
                    rounded="xl"
                    enableCrop={true}
                    cropMode="fixed"
                ...
                <div className="pt-2">
                  <p className="text-xs text-gray-500">
                    This is the primary image displayed on listing cards throughout the platform.
                  </p>
                </div>
              </div>
            </div>
