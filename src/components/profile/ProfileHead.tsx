...
function IconPosts() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" color="currentColor" fill="none" viewBox="0 0 24 24">
      <path d="M7.998 16H15.998M7.998 11H15.998" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <path d="M7.5 3.5c-1.556.047-2.484.22-3.126.862C3.496 5.242 3.496 6.657 3.496 9.488v6.506c0 2.831 0 4.246.879 5.126C5.253 22 6.668 22 9.496 22h5c2.828 0 4.242 0 5.121-.88.879-.88.879-2.295.879-5.126V9.488c0-2.831 0-4.246-.879-5.126-.642-.642-1.57-.815-3.126-.862" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  );
}
