...
const CreateChatButton: React.FC<CreateChatButtonProps> = ({
  ...
  const onCreateChat = useCallback(async () => {
    ...
    try {
      ...
      messageModal.onOpen(conversationId, otherUserId);  // Pass both arguments here
  ...
  return (
    <div 
      className="flex items-center justify-center bg-transparent backdrop-blur-lg rounded-full p-3 cursor-pointer shadow-sm border" 
