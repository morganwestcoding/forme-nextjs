...
const CreateChatButton: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center bg-[#e2e8f0] backdrop-blur-lg rounded-full p-3 cursor-pointer shadow-sm border border-white" onClick={onCreateChat}>
