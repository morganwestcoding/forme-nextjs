...
const Inbox: React.FC<InboxProps> = ({ currentUser }) => {
  ...
  return (
    <>
      <div 
        className="flex items-center justify-center bg-[#3E4142] backdrop-blur-lg rounded-full p-3 cursor-pointer shadow ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:rounded-full focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-25 hover:bg-white hover:bg-opacity-10 hover:text-accent-foreground" 
