  ...
  return (
    <div className="flex-grow relative">
      ...
      <input
        ...
        className="w-full text-[#71717A] placeholder:text-[#71717A] border bg-slate-50 border-neutral-500 rounded-lg p-3.5 pl-12 pr-24 text-sm shadow-sm shadow-gray-300"
      />
