 ...
 return (
   <div className="relative ml-8 w-64">
     <div className="relative">
       ...
       <input 
         type="text" 
         className="w-full text-sm p-3 pl-11 font-light pr-12 bg-black bg-opacity-35 shadow-sm rounded-lg border border-white dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 text-white focus:ring-blue-300 placeholder-white" 
         placeholder="Search" 
         value={searchTerm}
