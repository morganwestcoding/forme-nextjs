...
const ShopHeader: React.FC<ShopHeaderProps> = ({ 
  ...
  viewMode = 'grid',
  onViewModeChange = () => {},
  filters = { category: 'Featured', searchQuery: '' },
  onFilterChange = () => {}
}) => {
  ...
  const handleCategorySelect = (categoryLabel: string) => {
    if (filters.category === categoryLabel) {
      onFilterChange?.({ ...filters, category: 'Featured' });
    } else {
      onFilterChange?.({ ...filters, category: categoryLabel });
    }
  };
