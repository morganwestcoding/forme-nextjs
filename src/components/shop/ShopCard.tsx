        ...
        <div className="relative h-[300px] overflow-hidden">
          ...
          <div className="absolute top-4 left-4 z-20">
            <div className="bg-black/40 border border-white backdrop-blur-sm rounded-lg px-3 py-1.5 text-white">
              <span className="text-xs">{data.category || 'Shop'}</span>
            </div>
          </div>

          {/* Unified Info Section - Title, Location & Stats */}
          <div className="absolute bottom-5 left-5 right-5 text-white z-20">
            {/* Title and Location - No Background */}
            <div className="mb-3">
              ...
              <p className="text-sm drop-shadow-lg">
                {city && state ? `${city}, ${state}` : data.location || 'Online Shop'}
              </p>
            </div>
            
            {/* Stats Row - With Background */}
            <div className="bg-black/40 backdrop-blur-sm rounded-lg border-white border px-4 py-3 text-white">
