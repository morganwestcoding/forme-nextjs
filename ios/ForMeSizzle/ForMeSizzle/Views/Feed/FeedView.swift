...
private struct FeedTabs: View {
    ...
    var body: some View {
        // Lighter typographic treatment than TikTok's bold/medium pair so it
        // sits closer to the rest of the app: Inter semibold/regular, +0.2
        // tracking, and a slim 2pt capsule underline animated with spring +
        // matchedGeometryEffect to match other selection transitions in the
        // codebase.
        HStack(spacing: 28) {
            ForEach(Array(tabs.enumerated()), id: \.offset) { index, title in
                Button {
                    ...
                    VStack(spacing: 6) {
                        Text(title)
                            .font(ForMe.font(selectedTab == index ? .semibold : .regular, size: 15))
                            .tracking(0.2)
...
private struct ActionButton: View {
    ...
    // Sized for the TikTok-style overlay: outlines render at 30pt with a
    // 1.75 stroke (slightly heavier than the app's chrome 1.5 so they hold
    // up against busy photos, but lighter than HugeIcon's 2.0 default that
    // didn't match the rest of the app).
    private let iconSize: CGFloat = 30
    private let iconStroke: CGFloat = 1.75
    ...
    private var iconView: some View {
        ...
        case .heart:
            if isActive {
                ...
                HugeIcon(
                    paths: ["M19.4626 3.99415C16.7809 2.34923 14.4404 3.01211 13.0344 4.06801C12.4578 4.50096 12.1696 4.71743 12 4.71743C11.8304 4.71743 11.5422 4.50096 10.9656 4.06801C9.55962 3.01211 7.21909 2.34923 4.53744 3.99415C1.01807 6.15294 0.221721 13.2749 8.33953 19.2834C9.88572 20.4278 10.6588 21 12 21C13.3412 21 14.1143 20.4278 15.6605 19.2834C23.7783 13.2749 22.9819 6.15294 19.4626 3.99415Z"],
                    size: iconSize,
                    lineWidth: iconStroke
                )
            }
        case .comment:
            HugeIcon(
        ...
        case .bookmark:
            if isActive {
                ...
                HugeIcon(
                    paths: ["M4 17.9808V9.70753C4 6.07416 4 4.25748 5.17157 3.12874C6.34315 2 8.22876 2 12 2C15.7712 2 17.6569 2 18.8284 3.12874C20 4.25748 20 6.07416 20 9.70753V17.9808C20 20.2867 20 21.4396 19.2272 21.8523C17.7305 22.6514 14.9232 19.9852 13.59 19.1824C12.8168 18.7168 12.4302 18.484 12 18.484C11.5698 18.484 11.1832 18.7168 10.41 19.1824C9.0768 19.9852 6.26947 22.6514 4.77285 21.8523C4 21.4396 4 20.2867 4 17.9808Z"],
                    size: iconSize,
                    lineWidth: iconStroke
                )
            }
