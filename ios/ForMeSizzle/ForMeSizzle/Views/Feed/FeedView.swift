...
// MARK: - Web SVG Icon (renders SVG path data as stroked shape)
...
#Preview("Feed") {
    FeedView(posts: [
        Post(
            id: "1",
            content: "Fresh cut vibes",
            imageSrc: "https://images.unsplash.com/photo-1622286342621-4bd786c2447c?w=800",
            likes: ["a", "b", "c"],
        ...
        Post(
            id: "2",
            content: "Every artist was first an amateur. Keep pushing, keep growing, keep creating. The journey is the destination.",
            likes: ["a"],
            user: CompactUser(id: "u2", name: "Sarah C.")
        ),
        Post(
            id: "3",
            content: "New setup at the studio",
            imageSrc: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800",
            likes: ["a", "b"],
