              ...
              <PageSearch
                ...
                actionButtons={
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-1.5 rounded-xl text-stone-500 dark:text-stone-400 hover:text-stone-700 dark:hover:text-stone-200 hover:bg-stone-100 dark:bg-stone-800 dark:hover:bg-stone-800 transition-colors text-sm whitespace-nowrap"
                  >
