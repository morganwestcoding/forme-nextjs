      ...
      {location && (
        <div className="mb-4 flex items-center gap-3 px-4 h-14 rounded-2xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900">
          ...
          <button
            type="button"
            onClick={() => setLocation('')}
            className="text-xs font-medium text-stone-500 hover:text-stone-900 dark:text-stone-100 dark:hover:text-stone-100 transition-colors"
          >
            Change
          </button>
        </div>
      ...
      <div className="mt-4 mb-2 flex items-center justify-between gap-3">
        ...
        {!hasQuery && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-2.5 h-7 rounded-full text-xs font-medium text-stone-500 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100 hover:bg-stone-100 dark:bg-stone-800 dark:hover:bg-stone-800 transition-colors disabled:opacity-60"
          >
            {geoStatus === 'locating' ? (
