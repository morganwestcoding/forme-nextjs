      ...
      {currentUser ? (
        ...
        <div className="px-5 pb-4 flex gap-2.5">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-stone-50  hover:bg-stone-100 dark:hover:bg-stone-800 dark:bg-stone-800 text-stone-700 dark:text-stone-200 border border-stone-200 dark:border-stone-700/60 text-sm font-medium transition-all"
          >
