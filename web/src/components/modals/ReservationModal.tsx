          ...
          value={
            <div className="flex items-center gap-2">
              ...
              {paymentStatus === 'paid' && !isRefunded && (
                <span className="text-[10px] font-medium px-1.5 h-5 rounded-md inline-flex items-center bg-success-soft text-success-soft-foreground dark:bg-success/10 dark:text-success/70">
                  Paid
                </span>
              )}
              {isRefunded && (
      ...
      {isIncoming && isPending && !past ? (
        ...
        confirmCancel ? (
          <div className="rounded-2xl border border-danger-soft/70 dark:border-danger/30 bg-danger-soft/60 dark:bg-danger/10 px-4 py-3.5">
            <p className="text-[13px] font-semibold text-danger-soft-foreground dark:text-danger/70">
              {isIncoming ? 'Decline this booking?' : 'Cancel this booking?'}
            </p>
            <p className="text-[12px] text-danger-soft-foreground/80 dark:text-danger/70/80 mt-1">
              {isIncoming
            ...
            <div className="mt-3 flex items-center gap-2">
              ...
              <button
                ...
                disabled={busy}
                className="flex-1 inline-flex items-center justify-center gap-1.5 h-10 rounded-xl text-[13px] font-semibold text-white bg-gradient-to-b from-red-500 to-red-600 border border-danger/60 hover:from-red-400 hover:to-red-500 transition-all disabled:opacity-50"
              >
