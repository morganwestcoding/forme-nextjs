      ...
      <div className="flex flex-row gap-4 items-center w-full relative">
              ...
              <>
                ...
                <button
                  ...
                  className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-200 ${
                    disabled
                      ? 'bg-stone-100 dark:bg-stone-800 text-stone-300'
                      : 'bg-stone-100 dark:bg-stone-800 text-stone-500 dark:text-stone-400 dark:text-stone-500 hover:bg-stone-200 dark:bg-stone-700 hover:text-stone-700 dark:hover:text-stone-300 dark:text-stone-200 hover:scale-110 active:scale-95'
                  }`}
                >
        ...
        <div className={`flex flex-col justify-center min-w-0 flex-1 gap-1 ${showActions ? 'pr-16' : ''}`}>
          ...
          <div className="flex items-center gap-2 text-[12px]">
            {employeeName && (
              <>
                <span className="text-stone-500 dark:text-stone-400 dark:text-stone-500">with {employeeName}</span>
          ...
          {canRefund && (
            <button
              ...
              disabled={disabled}
              className="mt-1 text-[11px] font-medium text-stone-500 dark:text-stone-400 dark:text-stone-500 hover:text-red-600 transition-colors"
            >
              Request refund
            </button>
          )}
