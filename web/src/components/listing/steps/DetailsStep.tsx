      ...
      <div className="flex gap-6 items-center">
        ...
        >
          {({ open }) => (
            <div
              onClick={() => open?.()}
              className={`group cursor-pointer rounded-2xl overflow-hidden relative transition-all duration-200 flex-shrink-0 ${imageSrc ? 'hover:opacity-90' : 'border-2 border-dashed border-gray-300 hover:border-gray-400 bg-gray-50'}`}
