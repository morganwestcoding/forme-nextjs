              ...
              {!isOwner && (
                <div className="flex gap-2.5">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-stone-50  hover:bg-stone-100 dark:hover:bg-stone-800 dark:bg-stone-800 text-stone-700 dark:text-stone-200 rounded-xl text-sm font-medium transition-all border border-stone-200 dark:border-stone-700/60"
                    type="button"
                  >
          ...
          <div className="md:hidden mb-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {!isCustomer && (
                  <p className="text-sm text-stone-500  dark:text-stone-500">{jobTitle || 'Member'}</p>
                )}
              </div>
              <button
                onClick={handleDropdownToggle}
