...
const ReviewCard: React.FC<ReviewCardProps> = ({ review, currentUser }) => {
  ...
  return (
    <div className="group max-w-[250px] h-[280px] bg-white dark:bg-stone-900 rounded-2xl p-4 border border-stone-100 dark:border-stone-800 hover:border-stone-200  hover:shadow-elevation-2 hover:-translate-y-1 hover:scale-[1.01] transition-all duration-300 flex flex-col">
      {/* Header: Avatar + Name */}
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            {review.isVerifiedBooking && (
              <>
                ...
                <span className="inline-flex items-center gap-1 text-xs text-success-soft-foreground font-medium">
      ...
      <div className="flex items-center justify-center gap-0.5 pt-3 pb-4">
        {[1, 2, 3, 4, 5].map((star) => (
          <svg
            ...
            viewBox="0 0 24 24"
            className={`w-4 h-4 ${star <= review.rating ? 'text-warning/80' : 'text-stone-200'}`}
            fill="currentColor"
          >
