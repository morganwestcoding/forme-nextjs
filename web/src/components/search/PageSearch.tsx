          ...
          >
            {actions.map((item) => (
              <button
                ...
                className="w-full px-3 py-2.5 rounded-xl hover:bg-stone-50 dark:bg-stone-900 dark:hover:bg-stone-700 transition-colors duration-150 text-left text-sm font-medium text-stone-700 dark:text-stone-200"
                type="button"
              >
                {item.label}
              </button>
