        ...
        <div className="absolute bottom-6 left-6 right-6 z-20 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-600 ease-[cubic-bezier(0.23,1,0.32,1)]">
          ...
          <div className="flex-1 min-w-0">
            {!hideUserInfo && post.user && (
              <span className="text-white text-xs font-semibold truncate block drop-shadow-sm leading-none">
                {post.user.name}
                {isSample && (
            ...
            <div className="flex items-center gap-2 mt-[2px]">
              <p className="text-white/70 text-xs leading-none line-clamp-1 drop-shadow-sm flex-1 min-w-0">
