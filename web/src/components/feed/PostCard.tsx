          ...
          >
            ...
            {post.hasBeforeAfter && (
              <div className="absolute bottom-3 left-0 right-0 flex justify-center">
                <span className="w-[52px] h-[26px] flex items-center justify-center rounded-full text-[11px] font-medium backdrop-blur-md bg-white dark:bg-stone-900/95 text-stone-900 dark:text-stone-100">
                  After
                </span>
              </div>
            )}
