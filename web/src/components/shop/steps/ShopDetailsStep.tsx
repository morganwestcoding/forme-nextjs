      ...
      <div className="flex gap-6 items-center">
        ...
        >
          {({ open }) => (
            <div
              onClick={() => open?.()}
              className={`group cursor-pointer rounded-2xl overflow-hidden relative transition-all duration-200 flex-shrink-0 ${logo ? 'hover:opacity-90' : 'border-2 border-dashed border-gray-300 hover:border-gray-400 bg-gray-50'}`}
            ...
            >
              {logo ? (
                ...
                <div className="h-full flex flex-col items-center justify-center text-center p-2">
                  ...
                  <span className="text-xs font-medium text-gray-500">Add logo</span>
                </div>
              )}
