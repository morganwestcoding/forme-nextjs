    ...
    >
      ...
      <div className="flex flex-row gap-3">
        ...
        <div className="flex flex-col justify-center min-w-0">
          <h2 className="text-[15px] font-semibold text-stone-900 dark:text-stone-100 dark:text-stone-100 dark:text-stone-100 tracking-[-0.01em] leading-tight truncate">
            {data.name}
          </h2>
          <p className="text-[11px] text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 leading-none mt-1">
            {city && state ? `${city}, ${state}` : city || state || 'Location'}
          </p>
          <div className="flex items-center text-[11px] text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 leading-none mt-1.5 tabular-nums">
            ...
            <span className="text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500 dark:text-stone-500 dark:text-stone-400 dark:text-stone-500">{shopRating}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-1.5 mt-2.5">
        {[0, 1, 2, 3].map((i) => (
          <div key={i} className="relative w-9 h-9 rounded-xl overflow-hidden bg-stone-100 dark:bg-stone-800 dark:bg-stone-800 dark:bg-stone-800 flex-shrink-0">
            {products[i] ? (
              <Image
