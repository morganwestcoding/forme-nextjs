              ...
              <button
                ...
                className={`
                  ...
                  ${category === cat.label
                    ...
                    : 'border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-900 text-stone-700 dark:text-stone-200 shadow-[inset_0_0_0_rgba(0,0,0,0)] hover:border-stone-300 hover:bg-stone-50 dark:hover:bg-stone-800'
                  }
                `}
              >
                {cat.label}
