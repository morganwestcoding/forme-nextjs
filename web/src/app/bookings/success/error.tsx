...
export default function BookingSuccessError({
  error,
  reset,
}: {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 text-center">
      ...
      <h2 className="text-[16px] font-semibold text-stone-900 dark:text-stone-100 mb-1">Couldn&apos;t load booking details</h2>
