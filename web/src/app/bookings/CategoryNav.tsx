      ...
      {allCategories.map((category) => {
        ...
        return (
          <button
            ...
            className={`
              relative px-3 sm:px-4 h-9 flex items-center text-xs sm:text-sm font-medium rounded-xl border transition-all duration-200 active:scale-[0.97] whitespace-nowrap flex-shrink-0
              ${isSelected
