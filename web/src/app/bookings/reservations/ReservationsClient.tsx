            ...
            {isIncoming && isPending ? (
              <div className="grid grid-cols-2 grid-rows-2 gap-2 flex-1 w-full">
                ...
                <button
                  onClick={onDecline}
                  disabled={disabled}
                  className="inline-flex flex-col items-center justify-center gap-1.5 rounded-xl text-[13px] font-semibold text-white/85 bg-white dark:bg-stone-900/5 border border-white/15 hover:bg-danger/20 hover:text-red-100 hover:border-danger/40 transition-all disabled:opacity-50"
                >
              ...
              {isPending && (
                <>
                  ...
                  <button
                    onClick={onDecline}
                    disabled={disabled}
                    className="inline-flex items-center gap-1.5 px-4 h-9 rounded-full text-[12px] font-semibold text-white/85 bg-white dark:bg-stone-900/5 border border-white/15 disabled:opacity-50"
                  >
