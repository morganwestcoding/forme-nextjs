...
const MOCK_RESERVATIONS: SafeReservation[] = [
  ...
  { id: 'mock-res-3', createdAt: new Date().toISOString(), date: new Date(Date.now() + 1 * 86400000), time: '11:00', serviceName: 'Volume Lash Set', totalPrice: 150, status: 'pending', employeeId: 'emp-l3', userId: 'mc3', listingId: 'l3', user: mockUser('mc3', 'Sofia R.'), listing: mockListing('l3', 'Lash Lounge', '/assets/people/lashes.png', 'Lashes', 'Queens, NY', '25-11 Broadway', 'Luna K.') } as any,
