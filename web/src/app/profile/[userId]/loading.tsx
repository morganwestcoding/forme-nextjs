      ...
      <div className="w-[320px] flex-shrink-0 hidden md:flex flex-col gap-4 py-10">
        <div className="rounded-2xl overflow-hidden border border-stone-200/40 dark:border-stone-800 shadow-elevation-1 bg-white dark:bg-stone-900">
          <div className="relative pt-8 pb-5 px-6 text-center">
            ...
            <Skeleton rounded="full" className="h-24 w-24 mx-auto" />
          ...
          <div className="px-6 py-5 flex gap-2">
            ...
            <Skeleton rounded="xl" className="h-12 w-12" />
          </div>
        </div>
      </div>

      {/* Right column — services, posts, reviews */}
          ...
          <section>
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-0.5">
              {Array.from({ length: 8 }).map((_, i) => (
                <Skeleton key={i} rounded="none" className="aspect-square" />
              ))}
            </div>
          </section>
