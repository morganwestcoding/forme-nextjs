            ...
            {verificationStatus !== 'none' && (
              <div className="flex-shrink-0">
                {verificationStatus === 'verified' && (
                  <span className="inline-flex items-center gap-1.5 text-[12px] font-medium text-success-soft-foreground dark:text-success/80 bg-success-soft border border-success-soft/60 dark:bg-success/10 dark:border-success/20 px-3 py-1.5 rounded-full">
                    <CheckmarkCircle02Icon size={14} strokeWidth={1.5} /> Verified
                  </span>
                )}
                {verificationStatus === 'pending' && (
                  <span className="inline-flex items-center gap-1.5 text-[12px] font-medium text-warning-soft-foreground dark:text-warning/80 bg-warning-soft border border-warning-soft/60 dark:bg-warning/10 dark:border-warning/20 px-3 py-1.5 rounded-full">
                    <Clock01Icon size={14} strokeWidth={1.5} /> Pending
                  </span>
                )}
                {verificationStatus === 'rejected' && (
                  <span className="inline-flex items-center gap-1.5 text-[12px] font-medium text-danger-soft-foreground dark:text-danger/80 bg-danger-soft border border-danger-soft/60 dark:bg-danger/10 dark:border-danger/20 px-3 py-1.5 rounded-full">
        ...
        {activeTab === 'training' && (
          <div>
            ...
            {academiesLoading ? (
              ...
              <div className="text-[13px] text-danger py-8">Could not load academies. {academiesError}</div>
