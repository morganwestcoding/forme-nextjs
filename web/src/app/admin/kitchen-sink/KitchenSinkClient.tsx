  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-900 p-8">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <Card>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">Button — variants</h2>
        ...
        <Card>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">Button — sizes</h2>
        ...
        <Card>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">Button — states & icons</h2>
          <div className="flex flex-wrap gap-3">
        ...
        <Card>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">IconButton</h2>
        ...
        <Card>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">Input</h2>
        ...
        <div>
          <h2 className="text-[14px] font-semibold text-stone-900 dark:text-stone-100 mb-4">Card — padding scale</h2>
