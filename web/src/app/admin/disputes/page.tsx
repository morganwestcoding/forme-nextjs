    ...
    <Container>
      <div className="mt-8 mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-[14px] text-stone-400 dark:text-stone-500 mt-1">{disputes.length} disputes</p>
        </div>
                    ...
                    <tr key={dispute.id} className="border-b border-stone-100 dark:border-stone-800 hover:bg-stone-50/50 transition-colors">
                      ...
                      <td className="py-3 px-4">
                        <div>
                          ...
                          <p className="text-[11px] text-stone-400 dark:text-stone-500">{reservation?.user?.email || ''}</p>
                        </div>
                      </td>
                      <td className="py-3 px-4 text-stone-600 dark:text-stone-300">
