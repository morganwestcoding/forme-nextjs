  ...
  return (
    <>
      {stripeReturnedSuccess && (
        <div className="mb-6 rounded-xl border border-success-soft bg-success-soft p-4 text-sm text-success-soft-foreground">
              ...
              <div key={svc.id} className="flex items-center gap-3 py-3">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="text-xs text-danger hover:text-danger-soft-foreground px-2 py-1 transition-colors"
                  >
                    Delete
                  </button>
                </div>
