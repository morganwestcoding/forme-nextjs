              ...
              <div className="bg-stone-950/95 backdrop-blur-md rounded-2xl border border-stone-800 overflow-hidden shadow-elevation-4">
                ...
                <div className="px-3.5 pb-3.5 flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2 rounded-xl bg-white dark:bg-stone-900 text-stone-900 dark:text-stone-100 hover:bg-stone-100 text-sm font-medium transition-colors"
