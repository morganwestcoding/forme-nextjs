            ...
            <div className="flex items-start justify-between flex-wrap gap-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={saving}
                  className="px-4 py-2 rounded-xl text-xs font-medium bg-red-50 text-red-600 hover:bg-red-100 border border-red-200/60 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20 dark:border-red-500/20 transition-all"
                >
                  Cancel Plan
                </button>
              </div>
              ...
              <div key={plan.id} className={`group relative rounded-2xl border-2 p-6 transition-all duration-300 ${
                ...
                <div className="mb-6">
                  ...
                  {billing === "yearly" && price > 0 && (
                    <p className={`text-xs font-medium ${isPremium ? 'text-emerald-400 dark:text-emerald-600' : 'text-emerald-600'}`}>Save ${(plan.price.monthly * 12) - plan.price.yearly}/yr</p>
                  )}
